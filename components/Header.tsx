    ...
    <header className="fixed top-0 left-0 right-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md z-50 border-b border-pink-100 dark:border-slate-700/50">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600 dark:text-gray-300">
          <Link href="/" className="text-red-500 dark:text-red-400 border-b-2 border-red-500 dark:border-red-400 pb-1">{t.transfer}</Link>
          <Link href="/help" className="hover:text-red-500 dark:hover:text-red-400 transition-colors">{t.howItWorks}</Link>
          <Link href="/privacy" className="hover:text-red-500 dark:hover:text-red-400 transition-colors">{t.privacy}</Link>
          <Link href="/contact" className="hover:text-red-500 dark:hover:text-red-400 transition-colors">{t.contact}</Link>
        </nav>
