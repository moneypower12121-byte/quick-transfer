...
const TransferHistory: React.FC<TransferHistoryProps> = ({ onCodeClick }) => {
  ...
  return (
    <>
      ...
      >
        <History className="w-6 h-6 text-red-500" aria-hidden="true" />
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-end sm:items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 rounded-t-3xl sm:rounded-3xl w-full max-w-md max-h-[80vh] overflow-hidden shadow-2xl animate-in slide-in-from-bottom-4 duration-300">
            ...
            <div className="bg-gradient-to-r from-red-500 to-pink-500 p-5 flex items-center justify-between">
              ...
              >
                <X className="w-6 h-6" aria-label="close history" />
              </button>
            </div>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className={`p-2 rounded-lg ${
                      ...
                      {item.type === 'sent' ? (
                        <Send className="w-5 h-5 text-green-600 dark:text-green-400" aria-label="upload file icon" />
                      ) : (
                        <Download className="w-5 h-5 text-blue-600 dark:text-blue-400" aria-label="download file instantly" />
                      )}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 text-xs text-gray-400 dark:text-gray-500">
                        ...
                        <span className="flex items-center gap-1">
                          <Clock className="w-3 h-3" aria-label="secure file sharing timer" />
            ...
            <div className="p-4 border-t border-gray-100 dark:border-slate-700">
              ...
              >
                <Trash2 className="w-4 h-4" aria-label="clear history" />
